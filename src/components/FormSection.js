  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div
          className={classNames("container", { "container--medium": is_vert })}
        >
          <div
          ...
          >
            ...
            >
              <form
                ...
                method="POST"
                data-netlify="true"
                data-netlify-honeypot={"contact-form-bot-field"}
              ...
              >
                <div className="sr-only">
                  ...
                  <input
                    aria-labelledby={"contact-form-honeypot-label"}
                ...
                >
                  ...
                  <label htmlFor="inquiry">
                    {errors.inquiry && (
                      <span>
                        Please ensure the text of your inquiry is less than 250
                        words.
                      </span>
                    )}
                    <p>How might we support you? (required, max. 250 words)</p>
                    <textarea
                      name="inquiry"
                      rows={6}
                      {...register("inquiry", {
